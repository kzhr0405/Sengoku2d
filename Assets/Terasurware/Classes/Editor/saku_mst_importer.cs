        ...
        foreach (string asset in importedAssets)
        {
            ...
            using (FileStream stream = File.Open (filePath, FileMode.Open, FileAccess.Read))
            {
                ...
                foreach (string sheetName in sheetNames)
                {
					...
					cell = row.GetCell(24); p.shipFlg = (cell == null ? false : cell.BooleanCellValue);
					cell = row.GetCell(25); p.nameEng = (cell == null ? "" : cell.StringCellValue);
					cell = row.GetCell(26); p.effectionEng = (cell == null ? "" : cell.StringCellValue);
