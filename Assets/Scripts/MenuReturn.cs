...
public class MenuReturn : MonoBehaviour {
	...
	public void OnClick(){
        ...
        if (close.layer == 0) {
            ...
            AttackButton.transform.Find ("Text").GetComponent<Text> ().enabled = true;
			...
			if (soubujireiFlg) {
				...
				GaikouButton.transform.Find ("Text").GetComponent<Text> ().enabled = true;
				GaikouButton.GetComponent<Image> ().color = NGClorBtn;
				GaikouButton.GetComponent<Button> ().enabled = false;
				GaikouButton.transform.Find ("Text").GetComponent<Text> ().color = NGClorTxt;
			...
			BouryakuButton.transform.Find ("Text").GetComponent<Text> ().enabled = true;
			...
			if (kuniId == 16) {
				...
				CyouteiIcon.transform.Find("Text").GetComponent<Text>().enabled = true;
				CyouteiIcon.transform.Find("Image").GetComponent<Image>().enabled = true;
				...
				SyouninIcon.transform.Find ("Text").GetComponent<Text> ().enabled = true;
				SyouninIcon.transform.Find ("Image").GetComponent<Image> ().enabled = true;
