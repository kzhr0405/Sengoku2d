...
-(void)startAd
{
    ...
    [delegate setMovieReward:self inZone:_maioZoneId];
    [delegate setDelegate:self.delegate inZone:_maioZoneId];
    ...
    dispatch_once(&adfMaioOnceToken, ^{
        ...
        [Maio startWithMediaId:self.maioMediaId delegate:delegate];
    });
}
